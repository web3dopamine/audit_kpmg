import { getAllInternalTransactions, InternalTransactions } from '../../../api/etherscan/accounts';
import { wait } from '../../../utils/wait';

export const fetchAllInternalTransactions = async ({ address }: { address: string }) => {
